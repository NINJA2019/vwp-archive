// constants.js — 静的定数（app.js L1-14, 26-30, 63-68 相当）
...
export const I18N = {
  ja: { howtoMember:'メンバーで絞り込む', howtoTag:'タグで探す', howtoDaily:'今日の観測でランダムに発見', members:'メンバー', tags:'タグ', sort:'並び順:', newest:'新しい順', oldest:'古い順', dailyPick:'✦今日の観測', addVideo:'動画を追加', fetch:'取得', titleLabel:'タイトル', memberLabel:'メンバー', tagsLabel:'タグ', tagHint:'（#をつけてEnterで追加）', pubdate:'公開日', note:'メモ', cancel:'キャンセル', addBtn:'追加する', adminLogin:'管理者ログイン', loginDesc:'パスワードを入力すると動画の追加・削除ができます。', password:'パスワード', login:'ログイン', notFound:'動画が見つかりません', fetching:'取得中…', fetchOk:'✓ タイトル・公開日・サムネイルを取得しました', delConfirm:'この動画を削除しますか？', adding:'追加中…', searchPh:'タイトルで検索…', spotify:'Spotify', allTag:'すべて', dailyObs:'✦ Observer-Link',
    ...
    tagMap:{}, shelfAdd:'棚に追加', shelfRemove:'棚から削除', shelfFull:'棚がいっぱいです（10曲まで）', shelfEmpty:'曲カードの📌ボタンで棚に追加できます', shelfListenYt:'YouTubeで聴く', shelfAdded:'追加しました', shelfRemoved:'削除しました', shelfHint:'— ジャケットをタップして詳細 —', shelfSongs:'曲', shelfClose:'閉じる', shelfPanelClose:'パネルを閉じる', albumShelfTitle:'アルバム棚' },
...
export const MBR_CLS = {kafu:'mb-kafu',rime:'mb-rime',harusar:'mb-harusar',isekai:'mb-isekai',koko:'mb-koko',vwp:'mb-vwp'};

export const PAGE_SIZE = 30;
export const CARD_ANIM_DELAY_STEP = 0.022;
export const PW_SK = 'vwp_admin_pw';
export const THEME_SK = 'vwp_theme';
export const DAILY_MEMBERS = ['kafu','rime','harusar','isekai','koko'];
export const DAILY_SK = 'vwp_daily_obs';
